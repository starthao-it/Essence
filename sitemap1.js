...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">StarThảo-IT có ' + postTitle.length + ' bài viết<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">StarThảo-IT có ' + numDisplayed + ' posts labeled \'';
